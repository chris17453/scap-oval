...
using System.Xml.Serialization; 
 namespace oval{       [SerializableAttribute]
    ...
    [XmlRootAttribute("ndd_object", Namespace="http://oval.mitre.org/XMLSchema/oval-definitions-5#hpux", IsNullable=false)]
    public class ndd_object1 : ObjectType1 {
        private object[] itemsField;
        private ItemsChoiceType68[] itemsElementNameField;
        [XmlElementAttribute("device", typeof(EntityObjectStringType))]
        [XmlElementAttribute("parameter", typeof(EntityObjectStringType))]
