...
using System.Xml.Serialization; 
 namespace oval{       [SerializableAttribute]
    ...
    [XmlRootAttribute("line_object", Namespace="http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe", IsNullable=false)]
    public class line_object2 : ObjectType1 {
        private object[] itemsField;
        [XmlElementAttribute("show_subcommand", typeof(EntityObjectStringType))]
