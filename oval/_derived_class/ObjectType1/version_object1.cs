...
using System.Xml.Serialization; 
 namespace oval{       [SerializableAttribute]
    ...
    [XmlRootAttribute("version_object", Namespace="http://oval.mitre.org/XMLSchema/oval-definitions-5#junos", IsNullable=false)]
    public class version_object1 : ObjectType1 {
        private object[] itemsField;
        [XmlElementAttribute("component", typeof(EntityObjectStringType))]
