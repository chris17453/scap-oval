...
using System.Xml.Serialization; 
 namespace oval{       [SerializableAttribute]
    ...
    [XmlRootAttribute("dnscache_object", Namespace="http://oval.mitre.org/XMLSchema/oval-definitions-5#unix", IsNullable=false)]
    public class dnscache_object1 : ObjectType1 {
        private object[] itemsField;
        [XmlElementAttribute("domain_name", typeof(EntityObjectStringType))]
