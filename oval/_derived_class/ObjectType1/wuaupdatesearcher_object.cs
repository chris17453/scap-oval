...
using System.Xml.Serialization; 
 namespace oval{       [SerializableAttribute]
    ...
    public class wuaupdatesearcher_object : ObjectType1 {
        private object[] itemsField;
        [XmlElementAttribute("behaviors", typeof(WuaUpdateSearcherBehaviors))]
        [XmlElementAttribute("search_criteria", typeof(EntityObjectStringType))]
