...
using System.Xml.Serialization; 
 namespace oval{       [SerializableAttribute]
    ...
    public class pwpolicy59_object : ObjectType1 {
        private object[] itemsField;
        private ItemsChoiceType60[] itemsElementNameField;
        [XmlElementAttribute("directory_node", typeof(EntityObjectStringType), IsNullable=true)]
        [XmlElementAttribute("target_user", typeof(EntityObjectStringType), IsNullable=true)]
        [XmlElementAttribute("username", typeof(EntityObjectStringType), IsNullable=true)]
        [XmlElementAttribute("userpass", typeof(EntityObjectStringType), IsNullable=true)]
