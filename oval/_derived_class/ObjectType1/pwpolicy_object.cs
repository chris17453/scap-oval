...
using System.Xml.Serialization; 
 namespace oval{       [SerializableAttribute]
    ...
    public class pwpolicy_object : ObjectType1 {
        private object[] itemsField;
        private ItemsChoiceType59[] itemsElementNameField;
        [XmlElementAttribute("directory_node", typeof(EntityObjectStringType))]
        [XmlElementAttribute("username", typeof(EntityObjectStringType))]
        [XmlElementAttribute("userpass", typeof(EntityObjectStringType))]
