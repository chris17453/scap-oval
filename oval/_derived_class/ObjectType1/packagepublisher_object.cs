...
using System.Xml.Serialization; 
 namespace oval{       [SerializableAttribute]
    ...
    public class packagepublisher_object : ObjectType1 {
        private object[] itemsField;
        private ItemsChoiceType37[] itemsElementNameField;
        [XmlElementAttribute("name", typeof(EntityObjectStringType))]
        [XmlElementAttribute("origin_uri", typeof(EntityObjectStringType))]
        [XmlElementAttribute("type", typeof(EntityObjectPublisherTypeType))]
