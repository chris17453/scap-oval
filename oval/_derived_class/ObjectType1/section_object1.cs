...
using System.Xml.Serialization; 
 namespace oval{       [SerializableAttribute]
    ...
    [XmlRootAttribute("section_object", Namespace="http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe", IsNullable=false)]
    public class section_object1 : ObjectType1 {
        private object[] itemsField;
        [XmlElementAttribute("section_command", typeof(EntityObjectStringType))]
