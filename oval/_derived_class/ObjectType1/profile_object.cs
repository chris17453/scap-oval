...
using System.Xml.Serialization; 
 namespace oval{       [SerializableAttribute]
    ...
    public class profile_object : ObjectType1 {
        private object[] itemsField;
        private ItemsChoiceType70[] itemsElementNameField;
        [XmlElementAttribute("identifier", typeof(EntityObjectStringType))]
        [XmlElementAttribute("uuid", typeof(EntityObjectStringType))]
