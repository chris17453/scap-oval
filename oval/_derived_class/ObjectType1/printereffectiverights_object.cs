...
using System.Xml.Serialization; 
 namespace oval{       [SerializableAttribute]
    ...
    public class printereffectiverights_object : ObjectType1 {
        private object[] itemsField;
        private ItemsChoiceType22[] itemsElementNameField;
        [XmlElementAttribute("behaviors", typeof(PrinterEffectiveRightsBehaviors))]
        [XmlElementAttribute("printer_name", typeof(EntityObjectStringType))]
