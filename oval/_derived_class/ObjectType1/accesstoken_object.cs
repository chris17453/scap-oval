...
using System.Xml.Serialization; 
 namespace oval{       [SerializableAttribute]
    ...
    public class accesstoken_object : ObjectType1 {
        private object[] itemsField;
        [XmlElementAttribute("behaviors", typeof(AccesstokenBehaviors))]
        [XmlElementAttribute("security_principle", typeof(EntityObjectStringType))]
