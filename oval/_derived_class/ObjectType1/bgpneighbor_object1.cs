...
using System.Xml.Serialization; 
 namespace oval{       [SerializableAttribute]
    ...
    [XmlRootAttribute("bgpneighbor_object", Namespace="http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe", IsNullable=false)]
    public class bgpneighbor_object1 : ObjectType1 {
        private object[] itemsField;
        [XmlElementAttribute("neighbor", typeof(EntityObjectStringType))]
